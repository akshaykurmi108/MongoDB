use('ecommerce'); // batata hai ki is database ko use kar rahe hai
// to insert many data we use insertmany
...
//  creates a new collection & thats name is "contacts"
